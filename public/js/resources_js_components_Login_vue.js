...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/api/login', this.datos).then(function () {
        _this.$router.push({
          name: "Home"
        });
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.datos.user,
                    expression: "datos.user",
                  },
                ],
                staticClass: "form-control mb-2",
                attrs: { type: "text", placeholder: "Usuario" },
                domProps: { value: _vm.datos.user },
                on: {
                  input: function ($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.datos, "user", $event.target.value)
                  },
                },
              }),
              _vm._v(" "),
